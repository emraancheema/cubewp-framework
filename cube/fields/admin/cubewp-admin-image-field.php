...
class CubeWp_Admin_Image_Field extends CubeWp_Admin {
    ...
    public function render_image_field( $output = '', $args = array() ) {
        ...
        $attr           .= 'placeholder="'.esc_html__('Allowed only: image/png, image/jpg, image/jpeg, image/gif', 'cubewp-framework').'"';
		$output .= '<div class="cwp-custom-field cwp-upload-field">
            <div class="cwp-field">
                ...
                <a href="javascript:void(0);" class="button cwp-image-upload-button">' . esc_html__('Insert image', 'cubewp-framework') . '</a>
